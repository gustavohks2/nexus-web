...
<body>
	...
	<main class="mt-5">
		<div class="container">
			<h2 class="text-center"><span class="mr-4">Registrar Novo Aluno</span><img width="30"
					src="../../img/dumbbell.svg"></h2>
					...
					<form>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Nome</label>
									<input type="text" class="form-control" id="nome" placeholder="João Henrique">
								</div>
							</div>
							<div class="col-md-5">
								<div class="form-group">
									<label>Sobrenome</label>
									<input type="text" class="form-control" id="nome" placeholder="da Silva Nunes">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Data de Nascimento</label>
									<input type="text" class="form-control datepicker" id="nome"
						...
						<div class="row mt-5">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Celular</label>
									<input type="text" class="form-control" id="celular" placeholder="(99) 9 9999-9999">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Telefone Fixo</label>
									<input type="text" class="form-control" id="telefone-fixo"
						...
						<div class="row mt-5">
							<div class="col-md-4">
								<div class="form-group">
									<label>Peso</label>
									<input type="text" class="form-control" id="peso" placeholder="65">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label>Altura</label>
									<input type="text" class="form-control" id="altura" placeholder="1.80">
								</div>
							</div>
