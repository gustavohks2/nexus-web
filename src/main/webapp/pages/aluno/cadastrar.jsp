...
<html lang="pt-br">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-default">
                    <div class="navbar-collapse-header">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="index.html"> <img src="../../img/dumbbell.svg">
                                </a>
                            </div>
                    ...
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-icon" href="#"> <i
                        ...
                        <form action="/nexus-web/controller?action=CadastrarAluno" method="POST" id="form-cadastrar-aluno">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input type="text" name="nome" class="form-control" id="input-nome" placeholder="João Henrique">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label>Sobrenome</label>
                                        <input type="text" name="sobrenome" class="form-control" id="input-sobrenome" placeholder="da Silva Nunes">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Data de Nascimento</label>
                                        <input type="text" name="dataNascimento" class="form-control datepicker" id="input-data-nascimento"
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Celular</label>
                                        <input type="text" name="celular" class="form-control" id="input-celular" placeholder="(99) 9 9999-9999">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row mt-5">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Peso</label>
                                        <input type="text" name="peso" class="form-control" id="input-peso" placeholder="65">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Altura</label>
                                        <input type="text" name="altura" class="form-control" id="input-altura" placeholder="1.80">
                                    </div>
                                </div>
                                <div class="col-md-3 ml-2">
                                    ...
                                    <div class="d-flex flex-row ml-3">
                                        <div class="custom-control custom-radio mb-3 p-2 mr-5">
                                            <input name="sexo" class="custom-control-input" id="masculino"
                                                   type="radio">
                                            <label class="custom-control-label" for="masculino">Masculino</label>
                                        </div>
                                        <div class="custom-control custom-radio mb-3 p-2 ml-5">
                                            <input name="sexo" class="custom-control-input" id="feminino"
                                                   type="radio">
        ...
        <script src="../../node_modules/argon-design-system-free/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
